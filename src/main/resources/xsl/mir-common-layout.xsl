      ...
      <xsl:otherwise>
        <li class="nav-item dropdown">
          ...
          <a id="currentUser" class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
            <!-- fhswf modification, show user name or mail instead of user id-->
            <strong>
              <xsl:variable name="realName" select="mcrxsl:getCurrentUserAttribute('realName')" />
              <xsl:variable name="email" select="mcrxsl:getCurrentUserAttribute('email')" />
              <xsl:choose>
